...
class LoggingInterceptor extends Interceptor {
  ...
  void onError(
    ...
    if (err.response != null && err.response!.statusCode == 400) {
      print('check 400 error and response errr ${err.response}');
      logPrint('Handle 400 Bad Request Error');
      // Handle the 400 error as needed
      // For example, you might want to extract more information from err.response!
    }
