...
class CustomButtonsTabBar extends StatefulWidget
  ...
  CustomButtonsTabBar({
    ...
    required this.firstButtonRadius,
    required this.lastButtonRadius,
    this.elevation = 0,
  ...
  /// The value of the [radius] applied to each button.
  final BorderRadius radius;

  /// The value of the [radius] applied to first button.
  final BorderRadius firstButtonRadius;

  /// The value of the [radius] applied to last button.
  final BorderRadius lastButtonRadius;
...
class _CustomButtonsTabBarState extends State<CustomButtonsTabBar>
  ...
  @override
  void didUpdateWidget(CustomButtonsTabBar oldWidget) {
  ...
  Widget _buildButton(
    ...
    final BoxDecoration? boxDecoration = BoxDecoration.lerp(
        BoxDecoration(
          ...
          borderRadius: first
              ? widget.firstButtonRadius
              : last
                  ? widget.lastButtonRadius
                  : widget.radius,
        ),
        BoxDecoration(
            ...
            child: Row(
              ...
              children: List.generate(
                ...
                (int index) => _buildButton(index, widget.tabs[index] as Tab,
                    index == 0, index == widget.tabs.length - 1),
              ),
            ),
          ),
        ),
