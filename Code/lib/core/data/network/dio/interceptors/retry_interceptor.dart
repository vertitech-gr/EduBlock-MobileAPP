  ...
  Future<void> onError(DioError err, ErrorInterceptorHandler handler) async {
    ...
    if (err.response != null) {
      if (err.response!.statusCode == 400) {
        ...
        print('Handling HTTP 400 Bad Request Error ${err.response}');
        // Perform specific actions for HTTP 400 errors
      } else if (err.response!.statusCode == 500) {
        // Handle HTTP 500 Internal Server Error
        print('Handling HTTP 500 Internal Server Error ${err.response}');
        // Perform specific actions for HTTP 500 errors
      }
    }
